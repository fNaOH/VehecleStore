            ...
            <div id="top-header">
                <div class="container">
                    ...
                    <ul class="header-links pull-right">
                        ...
                        <li><a href="./JSP/login.jsp"><i class="fa fa-user-o"></i> Login</a></li>
                    </ul>
                </div>
            </div>
            <!-- /TOP HEADER -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="breadcrumb-tree">
                            ...
                            <li class="active"><a href="ProductServlet">All Categories</a></li>
                        </ul>
                    </div>
                </div>
                <!-- /row -->
                            ...
                            <div class="checkbox-filter">
                                ...
                                <div class="input-checkbox">
                                    <c:forEach items="${listCC}" var="o">
                                        ...
                                        <span class="${tag == o.category_id ? "active":""}">
                                            <a href="ProByCate?category_id=${o.category_id}">
                                                <option >${o.category_name}</option>
                                            </a>
                                        </span>
                                    </c:forEach>
                                ...
                                <c:forEach items="${listP}" var="o" >
                                    ...
                                    <div class="col-md-4 col-xs-6">
                                        <div class="product">
                                            ...
                                            <div class="product-body">
                                                <p class="product-category">${o.category_name}</p>
                                                <h3 class="product-name"><a href="Detail?product_id=${o.product_id}">${o.product_name}</a></h3>
                                                <h4 class="product-price">${o.list_price}</del></h4>
                        ...
                        <div class="store-filter clearfix">
                            ...
                            <ul class="store-pagination">
                                <c:forEach begin="1" end="${endP}" var="i">
                                    <li ><a class="${tag == i?"active":""}" href="Page?index=${i}">${i}</a></li>
                                    </c:forEach>
                            </ul>
                        </div>
